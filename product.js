...
{ id: 4, name: "Special Occasion Shoes", description: "Elegant and stylish shoes designed to make your little one look their best at parties, weddings, birthdays, and special events.", brand: "Mini Steps", price: 140, originalPrice: 175, discount: "20%", image: "productimages/spec.jpeg"},
            ...
            card.innerHTML = `
                ...
                <div class="product-info">
                    ...
                    <div class="cart-controls">
                        ...
                        <button class="buy-now-btn" data-id="${prod.id}">Order now</button>
                    </div>
                </div>
            `;
    ...
    if (checkoutForm) {
        checkoutForm.addEventListener('submit', function(e) {
            ...
            const body = `Hello Belle Elegance,\n\nI would like to place an order:\n\n${orderDetails}\n\nTotal: ₵${totalOrder}\n\nMy details:\n- Name: ${name}\n- Email: ${email}\n- Address: ${address}\n- Phone: ${phone}\n\nPlease confirm.`;
            const mailtoLink = `mailto:akotomandy74@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
